...
def make_point(step, x, y):
    direction = step[0]
    count = int(step[1:])
    if direction == "R":
        return [(x + i, y) for i in range(1, count + 1)]
    elif direction == "U":
        return [(x, y - i) for i in range(1, count + 1)]
    elif direction == "L":
        return [(x - i, y) for i in range(1, count + 1)]
    elif direction == "D":
        return [(x, y + i) for i in range(1, count + 1)]
