defmodule Day04Test do
  ...
  test "parse date" do
    assert Day04.parse_datetime("[1518-11-01 00:00] Guard #10 begins shift") ==
             elem(DateTime.from_iso8601("1518-11-01 00:00:00+0000"), 1)
  end
...
[1518-11-01 00:30] falls asleep
    [1518-11-01 00:55] wakes up"
      |> String.split("\n", trim: true)
      |> Day04.calculate_sleep_time({}, Map.new())
...
[1518-11-05 00:55] wakes up" |> String.split("\n", trim: true) |> Day04.solve()
    assert r == 10 * 24
  end
